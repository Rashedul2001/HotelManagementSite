...
{
    /// <inheritdoc />
    public partial class InitialSetUpGeneralDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelRoomAmenities", x => new { x.AmenitiesId, x.HotelRoomsId });
                    table.ForeignKey(
                        name: "FK_HotelRoomAmenities_Amenity_AmenitiesId",
                        column: x => x.AmenitiesId,
                        principalTable: "Amenity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelRoomAmenities_HotelRooms_HotelRoomsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImagesAndIcons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImagesAndIcons_HotelRooms_HotelRoomId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessTokenExpires = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_HotelRooms_HotelRoomId",
                        column: x => x.HotelRoomId,
                        principalTable: "HotelRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelRoomAmenities_HotelRoomsId",
                table: "HotelRoomAmenities",
                column: "HotelRoomsId");

            migrationBuilder.CreateIndex(
                name: "IX_ImagesAndIcons_HotelRoomId",
                table: "ImagesAndIcons",
                column: "HotelRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_HotelRoomId",
                table: "Reviews",
                column: "HotelRoomId");
